...
**Note**: Author-affiliation matching produces multiple output rows per input record (one per matched publication), while title matching produces one output row per input.
